package me.patothebest.gamecore.nms.v1_12_R1;

import com.google.common.collect.Sets;
import me.patothebest.gamecore.nms.v1_12_R1.goals.PathfinderGoalBlazeFireball;
import me.patothebest.gamecore.nms.v1_12_R1.goals.PathfinderGoalFollowOwner;
import me.patothebest.gamecore.nms.v1_12_R1.goals.PathfinderGoalGhastAttackTarget;
import me.patothebest.gamecore.nms.v1_12_R1.goals.PathfinderGoalOwnerHurtByTarget;
import me.patothebest.gamecore.nms.v1_12_R1.goals.PathfinderGoalOwnerHurtTarget;
import me.patothebest.gamecore.nms.v1_12_R1.goals.PathfinderGoalShulkerShoot;
...
public class NMSImpl implements NMS {
    ...
    public EntityType getEntityFromEgg(ItemStack itemStack) {
        ...
        if (tagCompound != null) {
            return EntityType.fromName(tagCompound.getCompound("EntityTag").getString("id").replace("minecraft:", ""));
        }
