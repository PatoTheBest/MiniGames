    ...
    public void e() {
        ...
        if (var0 != null) {
            ...
            if (var2 < 4.0D) {
                ...
                double var6 = var0.getBoundingBox().minY + (double) (var0.getHeight() / 2.0F) - (this.a.locY + (double) (this.a.getHeight() / 2.0F));
                ...
                if (this.c <= 0) {
                    ...
                    if (this.b > 1) {
                        ...
                        for (int var11 = 0; var11 < 1; ++var11) {
                            ...
                            var12.locY = this.a.locY + (double) (this.a.getHeight() / 2.0F) + 0.5D;
