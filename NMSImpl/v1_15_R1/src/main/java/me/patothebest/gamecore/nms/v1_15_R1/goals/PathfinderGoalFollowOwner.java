...
public class PathfinderGoalFollowOwner extends PathfinderGoal {
    ...
    @Override
    public void e() {
        this.entity.getControllerLook().a(this.entityOwner, 10.0F, (float) this.entity.dU());
    ...
    private void g() {
        BlockPosition blockposition = new BlockPosition(this.entityOwner);
    ...
    private boolean a(BlockPosition blockposition) {
        PathType pathtype = PathfinderNormal.b(this.world, blockposition.getX(), blockposition.getY(), blockposition.getZ());
        if (pathtype != PathType.WALKABLE) {
            return false;
        } else {
            BlockPosition blockposition1 = blockposition.b(new BlockPosition(this.entity));
