package me.patothebest.gamecore.nms.v1_8_R3;

import me.patothebest.gamecore.itemstack.Material;
import me.patothebest.gamecore.nms.v1_8_R3.goals.PathfinderGoalBlazeFireball;
import me.patothebest.gamecore.nms.v1_8_R3.goals.PathfinderGoalFollowOwner;
import me.patothebest.gamecore.nms.v1_8_R3.goals.PathfinderGoalGhastAttackTarget;
import me.patothebest.gamecore.nms.v1_8_R3.goals.PathfinderGoalOwnerHurtByTarget;
import me.patothebest.gamecore.nms.v1_8_R3.goals.PathfinderGoalOwnerHurtTarget;
...
public class NMSImpl implements NMS {
    ...
    public ArmorStand spawnProvisionalArmorStand(Location location) {
        ...
        Collection<org.bukkit.entity.Entity> nearbyEntities = location.getWorld().getNearbyEntities(location, 0.1, 0.1, 0.1);
        for (org.bukkit.entity.Entity nearbyEntity : nearbyEntities) {
            if (nearbyEntity instanceof ArmorStand) {
                return (ArmorStand) nearbyEntity;
            }
        }
