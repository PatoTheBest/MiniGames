...
import me.patothebest.gamecore.itemstack.ColoredWool;
...
public class RainWoolVictoryEffect extends RepeatingVictoryEffect {
    ...
    public void displayEffect(IPlayer player) {
        ...
        for (int i = 0; i < 15; ++i) {
            final FallingBlock block = nmsProvider.get().spawnFallingBlock(loc, ColoredWool.getRandomMaterial());
