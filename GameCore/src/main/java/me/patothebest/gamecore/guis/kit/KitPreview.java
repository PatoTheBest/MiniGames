...
public class KitPreview extends GUIPage {
    ...
    @Inject private KitPreview(CorePlugin plugin, @Assisted Player player, @Assisted Kit kit, PlayerManager playerManager, KitUIFactory kitUIFactory) {
    ...
    protected void buildPage() {
        ...
        addButton(new BackButton(getPlayer()).action(() -> kitUIFactory.createEditKitGUI(player, kit)), 45);
